...
/**
|--------------------------------------------------
| Page for all baseball items
|--------------------------------------------------
*/
class AllBaseball extends Component {
    /**
     ...
     */
    handleFilter = () => {
        let filtered = Filters.filterByCategory('baseball', this.props.productState.data);
...
export default connect(mapStateToProps)(AllBaseball)