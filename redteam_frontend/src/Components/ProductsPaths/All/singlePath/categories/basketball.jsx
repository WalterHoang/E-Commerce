...
/**
|--------------------------------------------------
| Page for all basketball items
|--------------------------------------------------
*/
class AllBasketball extends Component {
    /**
     ...
     */
    handleFilter = () => {
        let filtered = Filters.filterByCategory('basketball', this.props.productState.data);
...
export default connect(mapStateToProps)(AllBasketball)