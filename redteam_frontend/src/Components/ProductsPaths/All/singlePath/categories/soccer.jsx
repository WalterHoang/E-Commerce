...
/**
|--------------------------------------------------
| Page for all soccer items
|--------------------------------------------------
*/
class AllSoccer extends Component {
    /**
     ...
     */
    handleFilter = () => {
        let filtered = Filters.filterByCategory('soccer', this.props.productState.data);
...
export default connect(mapStateToProps)(AllSoccer)