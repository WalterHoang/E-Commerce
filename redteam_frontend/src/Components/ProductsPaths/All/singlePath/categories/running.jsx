...
/**
|--------------------------------------------------
| Page for all running items
|--------------------------------------------------
*/
class AllRunning extends Component {
    /**
     ...
     */
    handleFilter = () => {
        let filtered = Filters.filterByCategory('running', this.props.productState.data);
...
export default connect(mapStateToProps)(AllRunning)
