...
/**
|--------------------------------------------------
| Page for all Childrens Baseball items
|--------------------------------------------------
*/
class ChildrensBaseball extends Component {
    /**
    ...
    handleFilter = () => {
        ...
        // let filtered = Filters.filterByType('', this.props.productState.data);
        let result = Filters.filterByCategory('baseball', filtered);
...
export default connect(mapStateToProps)(ChildrensBaseball)