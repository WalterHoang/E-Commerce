...
/**
|--------------------------------------------------
| Page for all Children Soccer items
|--------------------------------------------------
*/
class ChildrensSoccer extends Component {
    /**
    ...
    handleFilter = () => {
        ...
        let result = Filters.filterByCategory('soccer', filtered);
...
export default connect(mapStateToProps)(ChildrensSoccer)