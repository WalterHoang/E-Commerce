...
/**
|--------------------------------------------------
| Page for all Children Golf items
|--------------------------------------------------
*/
class ChildrensGolf extends Component {
    /**
    ...
    handleFilter = () => {
        ...
        let result = Filters.filterByCategory('golf', filtered);
...
export default connect(mapStateToProps)(ChildrensGolf)