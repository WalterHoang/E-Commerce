...
/**
|--------------------------------------------------
| Page for all Childrens Shoes items
|--------------------------------------------------
*/
class ChildrensShoes extends Component {
    /**
    ...
    handleFilter = () => {
        ...
        let result = Filters.filterByType('shoes', filtered);
...
export default connect(mapStateToProps)(ChildrensShoes)
