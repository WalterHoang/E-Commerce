...
/**
|--------------------------------------------------
| Page for all Womens Equipment items
|--------------------------------------------------
*/
class WomensEquipment extends Component {
    /**
    ...
    handleFilter = () => {
        ...
        let result = Filters.filterByType('equipment', filtered);
...
export default connect(mapStateToProps)(WomensEquipment)