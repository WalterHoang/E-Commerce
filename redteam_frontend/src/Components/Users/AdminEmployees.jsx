...
class AdminEmployees extends Component {
    ...
    findAllEmployees() {
        ...
        this.props.userState.data.forEach(user => {
            user.role.forEach(role => {
                if ((Object.values(role).indexOf("EMPLOYEE") > -1) || Object.values(role).indexOf("ADMIN") > -1) {
        ...
        results = employees.filter((data, index) => {
            return employees.indexOf(data) === index;//returns the object of the array if the index is equal to the index of the compared object.
        });
    ...
    render() {
        ...
        if (this.props.userState.data !== null && this.props.userState.data !== undefined) {
            let employees = this.findAllEmployees();
            return (
                <div id="pages">

                    {/* <div className="addProd">
                        <Button onClick={this.setOpen}>Add Employee</Button>
                    </div> */}
